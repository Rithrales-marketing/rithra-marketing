...
# Önce environment variable'dan oku, yoksa varsayılan Streamlit Cloud URL'sini kullan
...
<style>
    ...
    /* Google Ads Butonları - Turuncu */
    button[data-testid*="google-ads"] {
        background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%) !important;
        color: white !important;
    }
    
    button[data-testid*="google-ads"]:hover {
        background: linear-gradient(135deg, #d97706 0%, #b45309 100%) !important;
    }
    
    /* Meta Ads Butonları - Mavi */
    button[data-testid*="meta-ads"] {
        background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%) !important;
        color: white !important;
    }
    
    button[data-testid*="meta-ads"]:hover {
...
def main():
    ...
    with st.sidebar:
        ...
        # Menü renkleri - Her menü için farklı renk
        menu_styles = {
            "container": {
                "padding": "0!important",
        ...
        # Seçili menüye göre dinamik renk vurgusu
        color_map = {
            "Genel Bakış": "linear-gradient(90deg, #6366f1 0%, #4f46e5 100%)",
            "SEO": "linear-gradient(90deg, #10b981 0%, #059669 100%)",
            "Google Ads": "linear-gradient(90deg, #f59e0b 0%, #d97706 100%)",
            "Meta Ads": "linear-gradient(90deg, #3b82f6 0%, #2563eb 100%)",
            "Ayarlar": "linear-gradient(90deg, #6b7280 0%, #4b5563 100%)"
        }
        
        selected_color = color_map.get(selected, "linear-gradient(90deg, #6366f1 0%, #4f46e5 100%)")
